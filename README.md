...
Отличная идея — это реально полезная сноска. Вот готовый блок Markdown, который можно вставить в README:
...
- `fps` — количество кадров в секунду в итоговой анимации  
- `tail` — длина отображаемого хвоста траектории  
...
генерирует около 10 000 кадров, а значит будет выполняться около 5 минут.
